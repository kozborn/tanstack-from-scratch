...
// npm/esm/deps/jsr.io/@std/fmt/1.0.7/colors.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/_os.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/assert_path.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/basename.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/strip_trailing_separators.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/constants.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/_util.js
function isPosixPathSeparator(code2) {
  return code2 === CHAR_FORWARD_SLASH;
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/basename.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/_util.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/basename.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/basename.js
function basename3(path, suffix = "") {
  return isWindows ? basename2(path, suffix) : basename(path, suffix);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/dirname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/dirname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/dirname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/dirname.js
function dirname3(path) {
  return isWindows ? dirname2(path) : dirname(path);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/extname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/extname.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/extname.js
function extname3(path) {
  return isWindows ? extname2(path) : extname(path);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/from_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/from_file_url.js
function fromFileUrl(url) {
  url = assertArg2(url);
  return decodeURIComponent(url.pathname.replace(/%(?![0-9A-Fa-f]{2})/g, "%25"));
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/from_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/from_file_url.js
function fromFileUrl3(url) {
  return isWindows ? fromFileUrl2(url) : fromFileUrl(url);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/is_absolute.js
function isAbsolute(path) {
  assertPath(path);
  return path.length > 0 && isPosixPathSeparator(path.charCodeAt(0));
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/is_absolute.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/is_absolute.js
function isAbsolute3(path) {
  return isWindows ? isAbsolute2(path) : isAbsolute(path);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/normalize.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/normalize_string.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/normalize.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/join.js
function join(...paths) {
  if (paths.length === 0)
    return ".";
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/normalize.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/join.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/join.js
function join3(...paths) {
  return isWindows ? join2(...paths) : join(...paths);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/normalize.js
function normalize3(path) {
  return isWindows ? normalize2(path) : normalize(path);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/resolve.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/relative.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/relative.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/resolve.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/relative.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/relative.js
function relative3(from, to) {
  return isWindows ? relative2(from, to) : relative(from, to);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/resolve.js
function resolve3(...pathSegments) {
  return isWindows ? resolve2(...pathSegments) : resolve(...pathSegments);
}

// npm/esm/deps/jsr.io/@std/path/1.0.9/_common/to_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/posix/to_file_url.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/windows/to_file_url.js
...
// npm/esm/deps/jsr.io/@std/fs/1.0.17/_get_file_info_type.js
function getFileInfoType(fileInfo) {
  return fileInfo.isFile ? "file" : fileInfo.isDirectory ? "dir" : fileInfo.isSymlink ? "symlink" : void 0;
}

// npm/esm/deps/jsr.io/@std/fs/1.0.17/ensure_dir.js
...
// npm/esm/deps/jsr.io/@std/fs/1.0.17/ensure_file.js
...
// npm/esm/deps/jsr.io/@std/path/1.0.9/constants.js
var SEPARATOR = isWindows ? "\\" : "/";

// npm/esm/deps/jsr.io/@std/fs/1.0.17/_is_subdir.js
...
// npm/esm/deps/jsr.io/@std/fs/1.0.17/copy.js
var isWindows2 = dntGlobalThis.Deno?.build.os === "windows";
...
// npm/esm/deps/jsr.io/@std/bytes/1.0.5/copy.js
...
// npm/esm/deps/jsr.io/@std/io/0.225.2/buffer.js
...
// npm/esm/deps/jsr.io/@std/io/0.225.2/write_all.js
...
// npm/esm/deps/jsr.io/@std/io/0.225.2/reader_from_stream_reader.js
...
// npm/esm/src/lib/rs_lib.internal.js
var rs_lib_internal_exports = {};
__export(rs_lib_internal_exports, {
  ...
  parse: () => parse3,
  static_text_clear_text: () => static_text_clear_text,
  static_text_render_once: () => static_text_render_once,
  static_text_render_text: () => static_text_render_text,
...
async function* readKeys() {
  return yield* innerReadKeys(Deno2.stdin);
}
async function* innerReadKeys(reader) {
  ...
  while (true) {
    ...
    const text = strip_ansi_codes(decoder2.decode(buf.slice(0, byteCount ?? 0), { stream: true }));
    if (text.length > 0) {
      yield text;
    }
  }
...
// npm/esm/deps/jsr.io/@std/fs/1.0.17/exists.js
...
async function executetouch(args, cwd) {
  ...
  for (const path of flags.paths) {
    ...
    try {
      const _f = __addDisposableResource(env_1, await Deno2.create(join3(cwd, path)), false);
    } catch (e_1) {
      env_1.error = e_1;
      env_1.hasError = true;
    } finally {
...
var InheritStaticTextBypassWriter = class {
  ...
  flush() {
    ...
    logger.logAboveStaticText(() => {
      writeAllSync2(this.#innerWriter, bytes2);
    });
    this.#buffer.reset();
  }
};
...
// npm/esm/src/commands/executable.js
...
async function evaluateWordParts(wordParts, context, quoted = false) {
  ...
  for (const stringPart of wordParts) {
    ...
    switch (stringPart.kind) {
      ...
      case "tilde": {
        const envVarName = Deno2.build.os === "windows" ? "USERPROFILE" : "HOME";
  ...
  return new CommandChild(async (resolve4, reject) => {
    try {
      ...
      let code2 = await spawn2(list, {
        stdin: stdin instanceof ReadableStream2 ? readerFromStreamReader(stdin.getReader()) : stdin,
        stdout,
        stderr,
      ...
      const result = new CommandResult(code2, finalizeCommandResultBuffer(stdoutBuffer), finalizeCommandResultBuffer(stderrBuffer), combinedBuffer instanceof Buffer2 ? combinedBuffer : void 0);
